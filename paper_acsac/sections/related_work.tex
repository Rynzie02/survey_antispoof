...
DiffAttack shows that output-only supervision can be weak and proposes intermediate-step supervision over the diffusion trajectory \cite{kang2023diffattack}. 
